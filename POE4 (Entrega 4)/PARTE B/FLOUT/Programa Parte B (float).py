...
titulo_archivo = "Caso I (PARTE B) (float)"
...
titulo_archivo = "Caso II driver ""ev"" y overwrite F (PARTE B) (float)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
...
titulo_archivo = "Caso II driver ""ev"" y overwrite T (PARTE B) (float)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
...
titulo_archivo = "Caso III driver ""evd"" y overwrite_a F (PARTE B) (float)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
...
titulo_archivo = "Caso III driver ""evd"" y overwrite_a T (PARTE B) (float)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
...
titulo_archivo = "Caso IV driver ""evr"" y overwrite_a F (PARTE B) (float)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
...
titulo_archivo = "Caso IV driver ""evr"" y overwrite_a T (PARTE B) (float)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
...
titulo_archivo = "Caso V driver ""evx"" y overwrite_a F (PARTE B) (float)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
...
titulo_archivo = "Caso V driver ""evx"" y overwrite_a T (PARTE B) (float)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
