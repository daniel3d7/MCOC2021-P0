...
titulo_archivo = "Caso III (double)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
...
titulo_archivo = "Caso VII (double)"
fid = open(f"Rendimiento {titulo_archivo}.txt", "w")
